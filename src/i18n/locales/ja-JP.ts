export default {
  ...
  debug: {
    ...
    backupConfig: '個人設定をバックアップ',
    backupConfigHint: 'config ディレクトリを zip バックアップとして保存します',
    backingUpConfig: '設定をバックアップ中...',
    restoreConfig: '個人設定を復元',
    restoreConfigHint: 'zip バックアップから config ディレクトリを復元します（再起動推奨）',
    restoringConfig: '設定を復元中...',
    devMode: '開発者モード',
