export default {
  ...
  debug: {
    ...
    backupConfig: 'Backup Personal Config',
    backupConfigHint: 'Pack the config directory into a zip backup file',
    backingUpConfig: 'Backing up config...',
    restoreConfig: 'Restore Personal Config',
    restoreConfigHint: 'Restore the config directory from a zip backup (restart recommended)',
    restoringConfig: 'Restoring config...',
