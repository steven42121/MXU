export default {
  ...
  debug: {
    ...
    backupConfig: '备份个人配置',
    backupConfigHint: '将 config 目录打包为 zip 备份文件',
    backingUpConfig: '正在备份配置...',
    restoreConfig: '恢复个人配置',
    restoreConfigHint: '从 zip 备份恢复 config 目录（建议恢复后重启）',
    restoringConfig: '正在恢复配置...',
    devMode: '开发模式',
