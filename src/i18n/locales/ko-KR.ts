export default {
  ...
  debug: {
    ...
    backupConfig: '개인 설정 백업',
    backupConfigHint: 'config 디렉터리를 zip 백업 파일로 저장합니다',
    backingUpConfig: '설정을 백업하는 중...',
    restoreConfig: '개인 설정 복원',
    restoreConfigHint: 'zip 백업에서 config 디렉터리를 복원합니다 (재시작 권장)',
    restoringConfig: '설정을 복원하는 중...',
    devMode: '개발자 모드',
